    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_filterable",
                    models.BooleanField(default=False, verbose_name="Фильтруемый ли?"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "slug",
                    models.SlugField(max_length=225, unique=True, verbose_name="Слаг"),
                ),
                (
                    "ordering",
        ...
        migrations.AddIndex(
            model_name="product",
            index=models.Index(
                fields=["name", "barcode"], name="inventory_p_name_6d311d_idx"
            ),
        ),
    ]
